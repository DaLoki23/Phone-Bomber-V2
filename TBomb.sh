...
banner() {
    ...
    if ! [ -x "$(command -v figlet)" ]; then
        ...
        figlet Phone-Bomber-V2
    fi
    if ! [ -x "$(command -v toilet)" ]; then
        echo -e "\e[4;34m This Bomber Was Created By \e[1;32mDaLoki23 \e[0m"
    else
        echo -e "\e[1;34mCreated By \e[1;34m"
        toilet -f mono12 -F border DaLoki23
    fi
    echo -e "\e[1;34m For Any Queries Join Me!!!\e[0m"
    echo -e "\e[1;32m           Discord: Da Loki#4380 \e[0m"
    echo -e "\e[4;32m   YouTube: https://www.youtube.com/channel/UC27q8OdGBigOCj4OUNSf0Ag \e[0m"
    echo " "
